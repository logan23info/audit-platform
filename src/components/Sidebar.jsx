...
import { User,
  ...
  X, LogOut, HelpCircle, CloudUpload, Truck, Layers, CalendarClock
} from 'lucide-react'
...
const iconMap = {
  ...
  RefreshCw, Building2, UserCheck, Lock, Cpu, Sparkles, Database,
  AlertOctagon, ShieldCheck, Zap, Star, GitMerge, FileCheck, List,
  HelpCircle, CloudUpload, Truck, Layers, CalendarClock
}
...
const navTooltips = {
  ...
  '/wiki': 'Step-by-step guide to using AuditIQ',
        ...
        <div className="px-4 py-3 border-t border-navy-700 flex-shrink-0">
          {profile && (
            <div className="flex items-center justify-between mb-2">
              ...
              <Tooltip text="Sign out of AuditIQ">
